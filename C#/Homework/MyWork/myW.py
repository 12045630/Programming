...
# Justify = откуда начинать печатать
# fg - фон текста, bg= фон заднего плана
# stick= W-west, E-East,N-North,S-South расширяет колоки в эти напралвения
# padx/y - расстояние между кнопкамим
...
win.grid_columnconfigure(0, minsize=60)  # размер колоки
win.grid_columnconfigure(1, minsize=60)
win.grid_columnconfigure(2, minsize=60)
win.grid_columnconfigure(3, minsize=60)

win.grid_rowconfigure(1, minsize=60)  # размер строчки
