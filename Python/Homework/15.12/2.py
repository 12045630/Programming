...
plt.annotate(
    r"Экстремум функции = $\frac{-b}{2a} = \frac{-4}{2} = -2$",
    xy=(-2, 9),
    xytext=(-5, 15),
...
fig.suptitle(title + "https://www.stat.ee/pressiteade-2019-127")
...
n, bins, patches = ax.hist(data, bins=bins_to_be, color="brown", edgecolor="black")
